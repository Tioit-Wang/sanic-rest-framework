...
from rest_framework.exceptions import ValidationException, ValidatorAssertError
...
class MaxValueValidator(BaseValidator):
    ...
    def __init__(self, max_value, **kwargs):
        if not isinstance(max_value, (int, float, decimal.Decimal)):
...
class MinValueValidator(BaseValidator):
    ...
    def __init__(self, min_value, **kwargs):
        if not isinstance(min_value, (int, float, decimal.Decimal)):
